...
export const AppProvider = ({ children }) => {
  const [product, setProduct] = useState([
    {
      id1: "1",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-acer-nitro-5-an515-45-r6ev_384a4f04a02f4269afdc5462b3c66708_master.png",
    ...
    },
    {
      id1: "2",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-asus-tuf-gaming-f15-fx506hc-hn144w-_ed2bb13600b34923810d060c6399bae0_master.jpg",
    ...
    },
    {
      id1: "3",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-lenovo-300e-chromebook_72c471d0721f4b2dbb2a0178cdda801a_master.jpg",
    ...
    },
    {
      id1: "4",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-fujitsu-lifebook-e5410_026baa2daf474dc4bf1f0965d0b95ed5_master.jpg",
  ...
  const [latestProduct, setLatestProduct] = useState([
    {
      id: "1",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-asus-gaming-tuf-dash-fx517zc-hn077w-_4b32e6259fe2459cba67735f224ac4fd_master.jpg",
    ...
    },
    {
      id: "2",
      image:
        "https://product.hstatic.net/200000420363/product/2_b12d2901df664cdaa30c3602da0c0c2f_master.jpg",
    ...
    },
    {
      id: "3",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-gaming-gigabyte-g5-ge_cef34f7b9432438e91cac1c4d94430b6_master.png",
    ...
    },
    {
      id: "4",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-asus-expertbook-b1400ceae--bv3186w_d18f2cf629e54c48b33103105e91105e_master.jpg",
    ...
    },
    {
      id: "5",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-asus-vivobook-15x-oled-a1503za-l1422w_7d84c75da414458091f257835d17f9f5_master.png",
    ...
    },
    {
      id: "6",
      image:
        "https://product.hstatic.net/200000420363/product/1_7787bd0239884d62aee2d701d9ab5ccb_master.jpg",
    ...
    },
    {
      id: "7",
      image:
        "https://product.hstatic.net/200000420363/product/1_a4602b98289e4c4cb85f0c02a363446c_master.jpg",
    ...
    },
    {
      id: "8",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-dell-inspiron-15-3520-i3u082w11blu_9e3468b8ccb6496593db164061932dab_master.png",
    ...
    },
    {
      id: "9",
      image:
        "https://product.hstatic.net/200000420363/product/laptop-hp-envy-x360-13-bf0090tu_580327bebdf040d48e8455b327547258_master.png",
  ...
  useEffect(() => {
    if (localStorage.getItem("cart_list_latest_product")) {
      setCartLatestProduct(
        JSON.parse(localStorage.getItem("cart_list_latest_product"))
      );
    }
  }, []);
  useEffect(() => {}, [cart]);
  useEffect(() => {}, [cartLatestProduct]);
  ...
  const addCartLatestProduct = (id) => {
    ...
    if (index >= 0) {
      ...
      localStorage.setItem(
        "cart_list_latest_product",
        JSON.stringify([...cartLatestProduct, { ...kq, qty: 1 }])
      );
    }
  ...
  const submit = (e) => {
    ...
    if (
      SignInEmail ===
        localStorage.getItem("inputRegisterEmail", registerEmail) &&
      SignInPassword ===
        localStorage.getItem("inputRegisterPassword", registerPassword)
    ) {
      return swal(
        "Sign In Successful!",
        "Welcome!" +
          " " +
          localStorage.getItem("inputRegisterUser", registerUser),
        "success"
      );
    } else {
