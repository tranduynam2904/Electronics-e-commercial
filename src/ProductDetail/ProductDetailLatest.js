...
export default function ProductDetailProductLatest() {
    ...
    const { id } = useParams()
    const detail = latestProduct.find((item) => item.id === id)
    return (
            ...
            <div className="product_detail">
                ...
                <div className='handle_detail_info'>
                    <div className='handle_condition'>
                        <h4>{detail.name}</h4>
                        <p style={{ lineHeight: '25px', color: '#FFBA00' }} className='review'>
                            <AiFillStar />
                            <AiFillStar />
                            <AiFillStar />
                            <AiFillStar />
                        ...
                        <p><span>Condition:</span> New product</p>
                        <p style={{ lineHeight: '30px' }}>Lorem ipsum is placeholder text commonly
                    ...
                    <div className='handle_stock'>
                        <p style={{ color: '#4CBB6C', fontWeight: 'bold' }}><span>Available In Stock: </span>10 items</p>
                        <div className="handle_flexinfo">
                            <div style={{ fontWeight: 'bold' }} className="handle_originalprice">
                                <p style={{ display: 'flex', alignItems: 'center' }}
                                >Price: ${detail.originalprice}</p>
                            </div>
