      ...
      <div className="rowaboutus">
        <div className="col">
          <div className="handle_aboutus">
            ...
            <p style={{ margin: "10px 0px" }}>
              ...
              eiusmod tempor incididun. Lorem ipsum dolor sit amet conse ctetur
        ...
        <div className="col">
          <div className="handle_aboutus">
            <h4>Our Team</h4>
            <img
              src="https://img.thuthuat123.com/uploads/2019/07/16/hinh-nen-cong-nghe-cho-laptop_100523537.jpg"
              alt="Technology Team"
            ></img>
        ...
        <div className="col">
          <div className="handle_aboutus">
            ...
            <p>
              ...
              amet conse ctetur adipisicing elit. Lorem ipsum dolor sit amet
