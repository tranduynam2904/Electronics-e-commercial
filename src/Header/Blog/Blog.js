            ...
            <div className="row">
                <div className="col">
                    <div className="card">
                        ...
                        <div className='link_blog'>
                            <Link to={`/blogs/blog1`}>Apple unveils 15-inch MacBook Air with M2 processor</Link>
                        </div>
                ...
                <div className="col">
                    <div className="card">
                        ...
                        <b>05 June 2023</b>
                        <div className='link_blog'>
                            <Link to={`/blogs/blog3`}>New 15-inch MacBook Air is the World’s Thinnest 15-inch Laptop</Link>
                        </div>
                ...
                <div className="col">
                    <div className="card">
                        ...
                        <b>05 June 2023</b>
                        <div className='link_blog'>
                            <Link to={`/blogs/blog4`}>Razer's ultra-premium ultra-light mouse</Link>
                        </div>
