...
export default function EmailCart() {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_33ptgom', 'template_i2dnaeh', form.current, 'OsHMSiH17MZW0cXJ-')
            .then((result) => {
            ...
            <form style={{ width: '100%' }} ref={form} onSubmit={sendEmail}>
                ...
                <div className='handle_form'>
                    ...
                    <div className='handle_input'>
                        ...
                        {phoneNumberError && <div style={{color:'red'}} className="error">{phoneNumberError}</div>}
                    </div>
                </div>
                <div className='handle_form'>
