    ...
    <div className="cart">
      ...
      <div className="handle_totalboard">
        ...
        <div className="handle_allinfo">
                      ...
                      <div className="handle_pricetotal">
                        <div className="handle_qty">
                          ...
                          <p className="handle_btn">
                            <button
                              className="btnminus"
                              onClick={() => minus(item.id1)}
                            >
                              -
                            </button>
                            <button
                              className="btnplus"
                              onClick={() => plus(item.id1)}
                            >
                              +
                            </button>
                          </p>
          ...
          {cartLatestProduct &&
            cartLatestProduct.map((item, index) => {
              return (
                <div className="handle_info">
                  <div className="img">
                    <img src={item.image} alt={item.name}></img>
                      ...
                      <div className="handle_pricetotal">
                        <div className="handle_qty">
                          ...
                          <p className="handle_btn">
                            <button
                              className="btnminus"
                              onClick={() => minusLatestProduct(item.id)}
                            >
                              -
                            </button>
                            <button
                              className="btnplus"
                              onClick={() => plusLatestProduct(item.id)}
                            >
                              +
                            </button>
                          </p>
                        ...
                        <button
                          className="remove"
                          onClick={() => removeItemLatestProduct(item.id)}
                        >
                          <FaTrash />
                        </button>
                      </div>
